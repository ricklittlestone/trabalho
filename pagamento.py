...
class Pagamento(Toplevel):
    def __init__(self, parent):
        ...
        self.lbl_numero3 = Label(self, text='Marcos Vinicius').grid(row=2, column=2, padx=5, pady=10)
        ...
        self.lbl_numero7 = Label(self, text='Eduardo').grid(row=4, column=2, padx=5, pady=10)
        ...
        self.lbl_numero13 = Label(self, text='Chevrolet Camaro 2018 cor Amarelo').grid(row=7, column=2, padx=5, pady=10)
        self.lbl_numero14 = Label(self, text='Obrigado(a), volte sempre !!').grid(row=9, column=1, padx=1, pady=1)
